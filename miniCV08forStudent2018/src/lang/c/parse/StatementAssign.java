...
public class StatementAssign extends CParseRule {
    ...
    public void codeGen(CParseContext pcx) throws FatalErrorException {
        ...
        if (primary != null && expression != null) {
            ...
            o.println("\tMOV\t-(R6), R0\t; StatementAssign:スタックトップから右辺の式の値を取り出す");
            o.println("\tMOV\t-(R6), R1\t; StatementAssign:スタックトップから左辺の書き込むべきのアドレスを取り出す");
            o.println("\tMOV\t  R0 ,(R1)\t; StatementAssign:書き込むべきアドレスに値を代入する");
        }

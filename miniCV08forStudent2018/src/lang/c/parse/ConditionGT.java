...
public class ConditionGT extends CParseRule {
    ...
    public void parse(CParseContext pcx) throws FatalErrorException {
        ...
        if (Expression.isFirst(tk)) {
            ...
            pcx.fatalError("Expressionが抜けています：conditionGT");
        }
    }
    ...
    public void codeGen(CParseContext pcx) throws FatalErrorException {
        ...
        if(left != null && right != null){
            ...
            o.println("\tMOV\t-(R6),R0\t;conditionGT: 2数を取り出して比べる");
            o.println("\tMOV\t-(R6),R1\t;conditionGT");
            o.println("\tMOV\t#0x0001,R2\t;conditionGT: set TRUE(1)");
            o.println("\tCMP\tR1,R0\t\t;conditionGT: R1>R0 = R0-R1<0");
            o.println("\tBRN\tLT" + seq + "\t\t;conditionGT:trueのとき遷移");
            o.println("\tCLR\tR2\t\t;conditionGT: set FALSE(0)");
